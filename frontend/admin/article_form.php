...
<div class="container my-4">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <textarea name="summary" class="form-control" rows="2"><?= htmlspecialchars($_POST['summary'] ?? '') ?></textarea>
        </div>
        <div class="mb-3">
            <label class="form-label">Contenu</label>
            <textarea name="content" class="form-control" rows="10" required><?= htmlspecialchars($_POST['content'] ?? '') ?></textarea>
        </div>
        <div class="mb-3">
        ...
        <div class="form-check mb-3">
            <input type="checkbox" name="published" class="form-check-input" id="published" <?= isset($_POST['published']) ? 'checked' : '' ?>>
